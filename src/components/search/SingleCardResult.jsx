    ...
    <div className="md:flex">
      ...
      <div className="p-8">
        ...
        <div className="mt-5">
          ...
          <p className="block text-lg text-left leading-tight font-medium text-black mt-5"><span className=" font-thin">Release Date</span>: {formatDate(results.release_date)}</p>
          <p className="block text-lg text-left leading-tight font-medium text-black mt-5"><span className=" font-thin">Rating</span>: {formatRating(results.vote_average)}</p>
